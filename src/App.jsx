...
const App = () => {
  ...
  return (
    <div className='w-full h-screen flex flex-col justify-center items-center bg-gray-900'>
      ...
      <div className='w-[30vw] h-[35vw] flex flex-col  items-center gap-4 py-4   rounded-lg bg-white'>
        <div className='flex flex-col gap-4  items-center  font-semibold'>
        <div className=' flex border-2 rounded-full text-white gap-4'>
          <input ref={inputref} className='h-[2vw] w-[15vw] flex items-center justify-center border-0 text-black outline-none px-2 rounded-lg' type="text" placeholder='enter your list ' />
